        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                <c:if test="${pageBean.currentPage == 1}">
                    ...
                    <a href="${pageContext.request.contextPath}/findByPageServlet?pageNumber=${pageBean.currentPage-1}" aria-label="Previous">
                ...
                <c:forEach begin="1" end="${pageBean.totalPage}" var="i">
                    <c:if test="${pageBean.currentPage == i}">
                        <li class="active"><a href="${pageContext.request.contextPath}/findByPageServlet?pageNumber=${i}">${i}</a></li>
                    </c:if>
                    <c:if test="${pageBean.currentPage != i}">
                        <li><a href="${pageContext.request.contextPath}/findByPageServlet?pageNumber=${i}">${i}</a></li>
                    </c:if>
                    ...
                    <a href="${pageContext.request.contextPath}/findByPageServlet?pageNumber=${pageBean.currentPage+1}" aria-label="Next">
